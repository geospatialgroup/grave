...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=r'/home/xulei/gd_12', help='file/dir/URL/glob/screen/0(webcam)')
    ...
    parser.add_argument('--project', default=r'/home/xulei/广东省', help='save results to project/name')
