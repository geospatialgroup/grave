...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=r'/home/xulei/pick_gd_pic/source_pic', help='file/dir/URL/glob/screen/0(webcam)')
    ...
    parser.add_argument('--project', default=r'/home/xulei/pick_gd_pic/detect', help='save results to project/name')
