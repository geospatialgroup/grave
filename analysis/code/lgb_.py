...
r2 = r2_score(s[:,0], y_test[:,0])
print("r2:",r2)

r = pearsonr(s[:,0], y_test[:,0])
print("r:",r)

filename = 'E:/青山白化/data/结果/lgb/' + 'y_test.mat'
if os.path.exists(filename):
    os.remove(filename)
hdf5storage.savemat( filename, {'y_test': y_test})


filename = 'E:/青山白化/data/结果/lgb/' + 'y_pre.mat'
if os.path.exists(filename):
    os.remove(filename)
hdf5storage.savemat( filename, {'y_pre': s})
